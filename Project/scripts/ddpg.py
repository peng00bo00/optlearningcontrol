...
actor = ActorNetwork(session,NUM_INPUTS,NUM_ACTION, env.action_space.high[0],CRITIC_ALPHA,TAU,MINIBATCH_SIZE)
...
for epoch in range(NUM_EPOCHS):
    for episode in range(NUM_EPISODES):
        ...
        while not done:
            ...
            # print(f"Epoch: {epoch}, Episode: {episode}, Step: {t}, Reward: {reward}")
